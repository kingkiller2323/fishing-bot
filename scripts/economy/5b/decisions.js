...
const APPROVED = {
	...
	'P-RODS-CUSTOM-LEVEL-RULE': 'D1: highest-part-rarity gate; releases L6B', 'P-RODS-CRAFT': 'D1: crafting from Lv 10', 'P-RODS-LEVEL-CAP': 'D1 final: required level = highest-rarity part; below it no /craft or /equip (L6B); parts ownable; Workshop previews the level; parts never weakened',
	'P-RODS-MEAN-FISH': 'D1 final: Common rod piece 1.05 fish/cast (was 1.10); every normal rod at most 1.80',
