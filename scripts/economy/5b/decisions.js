...
const DECISIONS = [
	...
	{ id: 'P-DAILY-FACTOR', status: 'proposed', title: 'Daily/weekly quests pay 1.0x the XP and cash of the fishing they require (a daily at most doubles its own session)', modelled: 1, alternatives: ['0.75 (needs a curve refit: regular L50 45.5 h otherwise)', '0.5'], source: 'quests design; R2 guardrail (docs/economy/5b/r2.json guardrailSensitivity)', why: 'the casual catch-up lever: minimum-daily players never lead engaged players by calendar week, but their XP per active hour is 1.6x the regular player\'s', get: () => { const q = require('./quests').PARAMS; return [q.daily.reward.xpK, q.daily.reward.cashK, q.weekly.reward.xpK, q.weekly.reward.cashK]; }, expected: [1, 1, 1, 1] },
