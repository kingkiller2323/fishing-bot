// Static seed data. Moved from src/scripts/generateSampleQuests.js; consumed by src/bootstrap/seed.js.
module.exports = [
	{
	...
	},
	{
		...
		// Reward items are referenced by catalog name and resolved to ObjectIds at seed time.
		rewardItems: ['Lucky Rod'],
		reward: [],
		cash: 3000,
		xp: 3000,
		requirements: {
