...
- **Framework 5b.5.** Every table below is **generated** by `node scripts/economy/5b/render-docs.js` from `scripts/economy/5b/aquarium.js` `markdownTables()`, and carries the framework version and shared digest it was computed at. Prose cites numbers only by pointing at a table. `check-shared.js` fails if a table is stale.
...
| Figure | Value | Table |
| --- | --- | --- |
| Today: `/pet play` → `/pet sell` | $300,000–$2,550,000 per hour from one pet; $10,200,000/h from one 3-pet tank (68.2× the best proposed fishing income) | Fixes |
...
| Regular player to L60 (integrated) | licenses 4.3% of income; bonus 3.39% of fish income; net −1.9% of income; Basic pays for itself in 44.9 h of play after purchase | Payback and shares |
...
| Pet income bound (worst case, weekly limit on) | $13,041/week: 9.0% of a casual and 1.8% of a regular player's fishing | Pet income bound |
| Display tanks (aspirational) | $3,000,000 per water type: 22.1 h of top-stage income for the regular player | Display tanks |
| Design checks | 9 of 11 pass | Checks |
...
<sub>Generated by `node scripts/economy/5b/render-docs.js` from `aquarium.js` markdownTables() at framework 5b.5 (digest d7374a03d62e8b81).</sub>
<!-- /generated:aquarium-headline -->
...
| `P-AQUARIUM-LEGACY-LICENSES` | Legacy licenses keep their stored fields and extra tanks; capacity is the larger of the stored and the new tank size; companion slots are level-capped; no refunds. Ordering: the /build tank limit (A6) ships before or with this read, or a cutoff applies | read-time LICENSE_DEFS by name; a legacy Expert gives 2 slots at Lv 15 and 5 at Lv 30 | a partial credit to legacy buyers; no level cap (legacy Expert holders get full slots early); grandfather only Habitats created before a cutoff (HabitatSchema createdAt; e.g. the approval date): tanks built later count against the new limit (Legacy tanks); upsize legacy tanks only up to the license's new tank count; extra legacy tanks keep their stored size (Legacy tanks) | no player document is rewritten; legacy buyers get more capacity than they paid for today (Legacy licenses). /build has no tank limit until A6 ships (A6 needs P-AQUARIUM-TANKS), so every tank built before then is grandfathered and upsized: a minute of /build matches the display-tank sink (Legacy tanks). Capacity only, no power; a cutoff closes this whatever the ship date | yes |
...
| `P-AQUARIUM-FIX-PLAY-SELL` | Fix first (A1): close the /pet play → /pet sell money loop (needs the proposed values of the four decisions it names; not a today's-numbers fix) | care cooldowns (P-AQUARIUM-CARE-COOLDOWN), capped bond (P-AQUARIUM-BOND), sale value from species, never XP (P-AQUARIUM-PET-SALE), weekly limit (P-AQUARIUM-SALE-LIMIT), atomic sale (A8) | cooldowns only (the sale still pays xp × attraction); remove pet sales | today one pet out-earns the best proposed fishing (Fixes) | yes |
| `P-AQUARIUM-FIX-BREEDING` | Fix first (A2, A3, A5): breeding compares rng.random() < rate, reads lastBred for the cooldown, and gives parents the success XP | thriving pair 65% per attempt (today 0.65%) | keep the percent comparison (breeding practically never succeeds); a new success formula | restores the intended odds; the cooldown keeps them from becoming a farm (Breeding). A2 and A5 use today's numbers; A3's cooldown length is P-AQUARIUM-BREEDING's proposed value. A2 must not ship before A1 is closed (more pets while the play-sell loop is open) and ships with A3 (Fixes) | yes |
...
The fixes are separate from tuning, but not all of them are free of balance values. The **Ships on** column says which ones change no balance value and which need a proposed value first: A1 cannot close the loop without the care cooldowns, bond cap, sale formula and weekly limit, and A6 cannot limit tanks without the tank counts. Each of those ships once its decision is approved. The note under the table gives the order.
...
| --- | --- | --- | --- | --- |
| Basic ($30,000) | 2.24 h (10.76 days) | 1.68 h (2.24 days) | 1.49 h (0.74 days) | 1.30 h (0.26 days) |
| Advanced ($120,000) | 3.35 h (16.10 days) | 2.49 h (3.32 days) | 2.20 h (1.10 days) | 1.91 h (0.38 days) |
| Expert ($260,000) | 4.30 h (20.65 days) | 3.18 h (4.24 days) | 2.81 h (1.40 days) | 2.43 h (0.49 days) |
...
| --- | --- | --- | --- | --- |
| Casual (12.5 min/day) | Lv 15 · 2.60 h · day 13 (at the gate) | Lv 30 · 12.30 h · day 59 (at the gate) | Lv 45 · 29.97 h · day 144 (at the gate) | Lv 15 / Lv 30 / Lv 45 |
| **Regular (45 min/day)** | Lv 15 · 2.52 h · day 4 (at the gate) | Lv 30 · 12.77 h · day 18 (at the gate) | Lv 45 · 32.72 h · day 44 (at the gate) | Lv 15 / Lv 30 / Lv 45 |
| Active (120 min/day) | Lv 17 · 4.02 h · day 2 (+1.40 h after the gate) | Lv 30 · 12.67 h · day 7 (at the gate) | Lv 45 · 32.60 h · day 17 (at the gate) | Lv 17 / Lv 30 / Lv 45 |
| Grinder (300 min/day) | Lv 18 · 3.67 h · day 1 (+1.30 h after the gate) | Lv 30 · 11.38 h · day 3 (at the gate) | Lv 45 · 29.85 h · day 6 (at the gate) | Lv 18 / Lv 30 / Lv 45 |
| Minimum-daily (R2 adversary) | Lv 15 · 1.40 h · day 25 (at the gate) | Lv 30 · 6.28 h · day 98 (at the gate) | Lv 45 · 16.80 h · day 203 (at the gate) | — |

Model: integrate.run(): the reference core loop (rods, world, quests, streak, buffs, upgrades), with variant.aquarium true against false. Licenses are non-blocking optional purchases, so rod assemblies and permits (blocking progression goals) are always served first; the licensed water type is Freshwater.
...
| --- | --- | --- | --- | --- |
| Lake · T2 (Lv 20) | $29,901/h | Basic | +1.00% | $299 |
| Pond · T3 (Lv 30) | $48,188/h | Advanced | +2.50% | $1,193 |
| Coast · T4 (Lv 40) | $81,753/h | Advanced | +2.50% | $2,004 |
| Swamp · T5 (Lv 50) | $135,758/h | Expert | +4.50% | $5,874 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Lv 15 | River · T1 | Freshwater | 404 | 4.35 | 0.83 | 0.03 | 2.4 h | 33 h |
| Lv 30 | Pond · T3 | Freshwater | 533 | 6.69 | 1.18 | 0.05 | 1.7 h | 20 h |
| Lv 45 | Coast · T4 | Saltwater | 627 | 8.69 | 1.56 | 0.07 | 1.3 h | 14 h |
...
| --- | --- | --- | --- |
| Casual (12.5 min/day) | **differs** (60 levels); with money bait **differs** | upgrade:tackleCare:2 2.60 h → 3.05 h; upgrade:baitConservation:2 2.60 h → 3.13 h; upgrade:trophyInstinct:2 2.60 h → 3.22 h; upgrade:knowledge:2 2.60 h → 3.35 h; upgrade:experience:2 2.60 h → 3.45 h; upgrade:casting:2 2.68 h → 3.63 h; upgrade:negotiation:2 2.90 h → 3.83 h; upgrade:tackleCare:6 48.50 h → 48.52 h; upgrade:baitConservation:6 48.50 h → 48.52 h; upgrade:trophyInstinct:6 48.50 h → 48.52 h; upgrade:knowledge:6 48.50 h → 48.52 h; upgrade:experience:6 48.50 h → 48.52 h; upgrade:casting:6 48.50 h → 48.52 h; upgrade:negotiation:6 48.50 h → 48.52 h | **no** |
| Regular (45 min/day) | **differs** (60 levels); with money bait **differs** | upgrade:tackleCare:2 2.52 h → 3.38 h; upgrade:baitConservation:2 2.52 h → 3.52 h; upgrade:trophyInstinct:2 2.52 h → 3.67 h; upgrade:knowledge:2 2.52 h → 3.77 h; upgrade:experience:2 2.73 h → 3.97 h; upgrade:casting:2 3.02 h → 4.25 h; upgrade:negotiation:2 3.12 h → 4.52 h; T2 rod assembly 5.17 h → 5.18 h (needed at Lv 20, 5.17 h); Lake permit 5.17 h → 5.18 h (needed at Lv 20, 5.17 h); upgrade:tackleCare:3 8.23 h → 8.25 h; upgrade:baitConservation:3 8.23 h → 8.25 h; upgrade:trophyInstinct:3 8.23 h → 8.25 h; upgrade:knowledge:3 8.23 h → 8.25 h; upgrade:experience:3 8.23 h → 8.25 h; upgrade:casting:3 8.23 h → 8.25 h; upgrade:negotiation:3 8.23 h → 8.25 h; upgrade:tackleCare:4 17.65 h → 17.67 h; upgrade:baitConservation:4 17.65 h → 17.67 h; upgrade:trophyInstinct:4 17.65 h → 17.67 h; upgrade:knowledge:4 17.65 h → 17.67 h; upgrade:experience:4 17.65 h → 17.67 h; upgrade:casting:4 17.65 h → 17.67 h; upgrade:negotiation:4 17.65 h → 17.67 h; T4 rod assembly 24.92 h → 24.93 h (needed at Lv 40, 24.92 h); Coast permit 24.92 h → 24.93 h (needed at Lv 40, 24.92 h); upgrade:tackleCare:6 54.13 h → 54.15 h; upgrade:baitConservation:6 54.13 h → 54.15 h; upgrade:trophyInstinct:6 54.13 h → 54.15 h; upgrade:knowledge:6 54.13 h → 54.15 h; upgrade:experience:6 54.13 h → 54.15 h; upgrade:casting:6 54.13 h → 54.15 h; upgrade:negotiation:6 54.13 h → 54.15 h | **no** |
| Active (120 min/day) | identical (60 levels); with money bait identical | none | yes |
| Grinder (300 min/day) | identical (60 levels); with money bait identical | upgrade:negotiation:3 7.48 h → 7.50 h | **no** |
| Minimum-daily (R2 adversary) | **differs** (60 levels) | upgrade:tackleCare:2 1.40 h → 1.45 h; upgrade:baitConservation:2 1.40 h → 1.45 h; upgrade:trophyInstinct:2 1.40 h → 1.50 h; upgrade:knowledge:2 1.40 h → 1.58 h; upgrade:experience:2 1.40 h → 1.65 h; upgrade:casting:2 1.40 h → 1.73 h; upgrade:negotiation:2 1.40 h → 1.85 h; upgrade:tackleCare:5 16.78 h → 16.80 h; upgrade:baitConservation:5 16.78 h → 16.80 h; upgrade:trophyInstinct:5 16.78 h → 16.80 h; upgrade:knowledge:5 16.78 h → 16.80 h; upgrade:experience:5 16.78 h → 16.80 h; upgrade:casting:5 16.78 h → 16.80 h; upgrade:negotiation:5 16.78 h → 16.80 h | **no** |
...
| --- | --- | --- | --- | --- | --- |
| All-Common pets (floor) | 1.70% | 99% / 35% / 16% | 66.5* / 130.1* / 191.2* | 4.4% | −3.1% |
| All-Rare pets | 2.38% | 138% / 49% / 23% | 54.2 / 97.4* / 138.0* | 4.3% | −2.6% |
| **All-Legendary pets (typical)** | 3.39% | 197% / 70% / 33% | 44.9 / 72.8* / 98.1* | 4.3% | −1.9% |
| All-Lucky pets (ceiling) | 3.73% | 217% / 77% / 36% | 43.0 / 67.6* / 89.6* | 4.3% | −1.7% |
| Pets thriving 50% of the time | 1.70% | 99% / 35% / 16% | 66.5* / 130.1* / 191.2* | 4.4% | −3.1% |
| Money bait on (both sides) | 3.39% | 209% / 74% / 35% | 43.0 / 68.1* / 90.7* | 4.1% | −1.7% |

| Player | License spend, one water type (share of income) | Both water types | Net, both water types | Bonus / fish income, both |
| --- | --- | --- | --- | --- |
| Casual (12.5 min/day) | 4.3% | 8.6% | −7.1% | 3.40% |
| Regular (45 min/day) | 4.3% | 8.6% | −6.2% | 3.39% |
| Active (120 min/day) | 4.5% | 9.0% | −6.2% | 3.30% |
| Grinder (300 min/day) | 4.6% | 9.3% | −6.6% | 2.91% |
...
| --- | --- | --- | --- | --- | --- | --- |
| Basic (River · T1) | $17 | **120%** | 25.0% | 8.3% | 2.9% | 1.2% |
| Advanced (Pond · T3) | $45 | **121%** | 25.0% | 8.3% | 2.9% | 3.0% |
| Expert (Coast · T4) | $75 | **122%** | 25.0% | 8.3% | 2.9% | 5.4% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Legendary ($3,478) | Expert, one water type (15) | age to full value | 2.12 | 2.12 | $4,607 | 3.2% | 0.7% | 0.2% | 0.1% |
| Legendary ($3,478) | Expert, both water types + all display tanks (60) | age to full value | 8.48 | 3.00 | $18,427 → **$6,520** | 12.7% → 4.5% | 2.6% → 0.9% | 0.9% → 0.3% | 0.3% → 0.1% |
| Lucky ($6,955) | Expert, one water type (15) | age to full value | 2.12 | 2.12 | $9,213 | 6.4% | 1.3% | 0.4% | 0.2% |
| Lucky ($6,955) | Expert, both water types + all display tanks (60) | age to full value | 8.48 | 3.00 | $36,854 → **$13,041** | 25.4% → 9.0% | 5.2% → 1.8% | 1.7% → 0.6% | 0.6% → 0.2% |

An upper bound: thriving parents (65%), the most valuable Swamp species, every baby at maximum attraction, the better of selling at birth and aging to full value, then the weekly limit. Shares are of weekly fishing income at Swamp · T5. The minimum-daily player (R2) can take at most the capped figure; the aquarium gives it no XP (Effects on progression).
...
| `src/class/Aquarium.js` | `updateStatus`: no temperature drift; cleanliness decay unchanged. `effectiveTemperature` clamp. Effective capacity = max(stored `size`, license `tankSize`), shipped no earlier than the `build.js` tank limit (A6), or restricted by the option chosen in `P-AQUARIUM-LEGACY-LICENSES` (Legacy tanks). `compareBiome`: Mountain Stream as Freshwater. |
...
| `src/commands/slash/Pet/build.js` | Tank limit = license `tanks` (+ display tanks), counted per water type (A6). Existing extra tanks stay usable. New tanks start at the ideal. **Ordering:** the limit ships before or in the same deploy as the effective-capacity read in `Aquarium.js`. Until it ships, every tank a player builds (one per `/build` cooldown) is grandfathered and later read at the new tank size (Legacy tanks). With the cutoff option, only Habitats with `createdAt` before the cutoff are grandfathered; later ones count against the limit. |
...
- **Player documents: no rewrite** (`P-AQUARIUM-LEGACY-LICENSES`).
  ...
  - **Aquariums:** every existing `Habitat` stays usable, including tanks beyond the new limit. They are grandfathered; only new builds are limited. **Ordering:** `/build` has no tank limit until A6 ships, and A6 needs `P-AQUARIUM-TANKS`. Every tank built before then is grandfathered and read at the new tank size, so a minute of `/build` today can match the display-tank capacity of a water type (Legacy tanks). Ship the tank limit before or with the effective-capacity read, and pick one of the options in `P-AQUARIUM-LEGACY-LICENSES`: as proposed (every tank upsized), grandfather only Habitats created before a cutoff (`HabitatSchema` has `timestamps: true`), or upsize only up to the license's new tank count.
...
`report().legacyTanks`: what tanks built before A6 ships become, per water type.
...
- The effect is capacity only. Companion slots come from the license tier, so extra tanks give no power, and pet cash stays under the weekly sale limit. What changes is the display-tank sink: players who build tanks before A6 ships get that capacity for free.
- The cutoff option closes the gap whatever the ship date of A6: only tanks that existed at the cutoff are grandfathered. Habitats created after it count against the new limit; any beyond it keep the pets they hold (nothing is deleted) and take no new ones. The upsize-limit option keeps every tank usable but reads extra legacy tanks at their stored size.
...
5. **A6 / A7:** `/build` stops at the license's tank count, and an account with more legacy tanks keeps them all usable; an owned license is not offered again. Under the option chosen in `P-AQUARIUM-LEGACY-LICENSES`: with the cutoff, a Habitat created after it counts against the limit and is not upsized; with the upsize limit, only as many legacy tanks as the license's tank count read at the new size.
...
- **Tanks built before A6 ships** are grandfathered and upsized as proposed. A player who spams `/build` before the fix gets display-tank capacity for free (Legacy tanks). Ship A6 before or with the license read, or choose the cutoff option (`P-AQUARIUM-LEGACY-LICENSES`).
- **Fix ordering.** A1 needs four proposed values and A6 one; A2 must not ship before A1 is closed (Fixes, Ships on).
...
| pet income bound (any parents, any capacity) within the target share of a regular player's fishing | <= 0.05 | 0.0183 | pass |
| pet income bound (any parents, any capacity) within the target share of a casual player's fishing | <= 0.1 | 0.0898 | pass |
| the aquarium adds no XP: every level is reached on the same step with the same XP by source, with and without it (integrated: every archetype and the minimum-daily player; reference loop and money bait) | yes | **no** | **fail** |
...
| licenses never delay progression: every rod assembly or permit they move is still bought by the time its level is reached, and none is dropped (integrated) | yes | **no** | **fail** |
| reference player earns each license back within its payback target, and higher tiers take longer (integrated) | basic 60, advanced 90, expert 120 | basic 44.92, advanced 72.84, expert 98.05 | pass |
