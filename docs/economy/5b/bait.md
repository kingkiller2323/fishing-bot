...
| XP-bait guard, every archetype: a net sink, and at most the cap sooner than its own no-bait run | net sink: every archetype; cap 10%: **over for regular, active, grinder**; largest 11.7% (grinder, L60) | XP-bait guard |
...
| Always-on XP bait: milestone active time against the same archetype without bait, every milestone from L20 (integrated) | ≤ 10% sooner (roughly) | casual 6.8% (L60), regular 10.0% (L60), active 11.4% (L60), grinder 11.7% (L60) | **flag for the user**: over for regular, active, grinder (`P-BAIT-XP-SIZING`) |
...
| Level | Approved window (no-bait reference) | No bait | No bait inside the window | Money bait (goal cash) | XP bait (goal xp) | XP-bait speed-up | Within the 10% guard |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| L60 | — | 68.37 h | — | 67.18 h | 61.52 h | 10.0% | **no** |
...
| Archetype | L50 no bait | L50 money bait | L50 XP bait | Largest money-bait speed-up | Largest XP-bait speed-up | Over the 10% guard |
| --- | --- | --- | --- | --- | --- | --- |
| casual (12.5 min/day) | 38.95 h | 38.55 h | 36.47 h | 1.2% (L60) | 6.8% (L60) | no |
| regular (45 min/day) | 42.93 h | 42.55 h | 38.93 h | 1.7% (L60) | 10.0% (L60) | **yes** |
| active (120 min/day) | 43.13 h | 42.32 h | 38.42 h | 2.0% (L60) | 11.4% (L60) | **yes** |
| grinder (300 min/day) | 39.25 h | 38.50 h | 34.92 h | 2.1% (L60) | 11.7% (L60) | **yes** |
