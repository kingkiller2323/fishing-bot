...
| Spinner on any rod tier in Lake and Pond, clamped at the ceiling | mean fish per cast up to 1.800 (ceiling 1.80: never above); the clamp binds on T4, T5, no extra fish on T5; unclamped it would reach 1.952 (`P-BAIT-SPINNER-TIERS`) | Spinner by rod tier |
...
| Money bait always on, regular player (integrated) | net +1.7% of income; milestones at most 1.7% sooner | Regular player; Income and XP sources |
| XP bait always on, regular player (integrated) | L50 43.52 h → 39.42 h; largest speed-up 9.7% at L60; net −8.9% of income | Regular player |
| XP-bait guard, every archetype: a net sink, and at most the cap sooner than its own no-bait run | net sink: every archetype; cap 10%: **over for active, grinder**; largest 11.8% (grinder, L60) | XP-bait guard |
...
| Rod (from Lv) | Biome | Mean fish/cast: rod → with Spinner (clamped) | Spinner adds | With Spinner: P(3+) / P(5) | Above the ceiling (1.80) | Above the mid band's rod range (1.30, informational) | XP/cast: with Spinner here → rod's usual biome, no bait | $/cast after bait → rod's usual biome, no bait | Alternative: no clamp | Alternative: clamp at the mid band's range | Alternative: Spinner only up to T2 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Old Rod (Lv 0) | Lake | 1.00 → 1.152 | +0.152 | 3.5% / 0.43% | no | no | 21.48 → 18.65 (Lake) | $36.23 → $51.87 | 1.152 | 1.152 | 1.152 |
| Old Rod (Lv 0) | Pond | 1.00 → 1.152 | +0.152 | 3.5% / 0.43% | no | no | 21.48 → 18.65 (Lake) | $69.32 → $51.87 | 1.152 | 1.152 | 1.152 |
| T1 (Lv 20) | Lake | 1.20 → 1.352 | +0.152 | 8.1% / 0.99% | no | yes | 25.36 → 22.52 (Lake) | $63.34 → $77.10 | 1.352 | 1.300 | 1.352 |
| T1 (Lv 20) | Pond | 1.20 → 1.352 | +0.152 | 8.1% / 0.99% | no | yes | 25.36 → 22.52 (Lake) | $96.15 → $77.10 | 1.352 | 1.300 | 1.352 |
| T2 (Lv 30) | Lake | 1.30 → 1.452 | +0.152 | 10.4% / 1.28% | no | yes | 27.40 → 24.54 (Pond) | $73.83 → $120.07 | 1.452 | 1.300 | 1.452 |
| T2 (Lv 30) | Pond | 1.30 → 1.452 | +0.152 | 10.4% / 1.28% | no | yes | 27.40 → 24.54 (Pond) | $110.56 → $120.07 | 1.452 | 1.300 | 1.452 |
| T3 (Lv 40) | Lake | 1.50 → 1.652 | +0.152 | 15.0% / 1.84% | no | yes | 31.40 → 28.52 (Coast) | $92.92 → $203.14 | 1.652 | 1.500 | 1.500 |
| T3 (Lv 40) | Pond | 1.50 → 1.652 | +0.152 | 15.0% / 1.84% | no | yes | 31.40 → 28.52 (Coast) | $136.78 → $203.14 | 1.652 | 1.500 | 1.500 |
| T4 (Lv 50) | Lake | 1.65 → 1.800 (clamped) | +0.150 | 18.5% / 2.26% | no | yes | 34.53 → 31.66 (Swamp) | $110.60 → $330.51 | 1.802 | 1.650 | 1.650 |
| T4 (Lv 50) | Pond | 1.65 → 1.800 (clamped) | +0.150 | 18.5% / 2.26% | no | yes | 34.53 → 31.66 (Swamp) | $161.03 → $330.51 | 1.802 | 1.650 | 1.650 |
| T5 (Lv 60) | Lake | 1.80 → 1.800 (clamped) | **nothing** | 18.5% / 2.26% | no | yes | 34.53 → 34.53 (Swamp) | $110.60 → $360.55 | 1.952 | 1.800 | 1.800 |
| T5 (Lv 60) | Pond | 1.80 → 1.800 (clamped) | **nothing** | 18.5% / 2.26% | no | yes | 34.53 → 34.53 (Swamp) | $161.03 → $360.55 | 1.952 | 1.800 | 1.800 |

`volumeCheck()`: framework multi-catch chain on the rod's chance + Spinner's 10%, the combined chance capped at the chance whose mean is the ceiling (`rods.PARAMS.multi.ceilingMean`, `P-RODS-MEAN-FISH`; `PARAMS.volume`, the same clamp in `system()`). The mid band's rod range is the highest mean of the rods typical in Lake and Pond (T1, T2). "Rod's usual biome" is the highest biome open at the rod's level (at least Lake). The alternative columns are a sensitivity for `P-BAIT-SPINNER-TIERS`, not proposals. Spinner's effect at its home stages (and so its price) is unchanged by the ceiling clamp, and would be **changed** by the mid-band clamp and unchanged by the tier limit.
...
| Volume bait (Spinner): against the mid band's rod range | 1.30 (informational: the clamp is at the ceiling, not here) | above the range on T1, T2, T3, T4, T5 | reported |
| No money bait above the band at a typical stage outside its home | ≤ 1.7 | none above | pass |
| Always-on XP bait remains a net economic sink, every archetype (integrated) | bait bought > extra catch value | casual −5.4% of income, regular −8.9% of income, active −11.0% of income, grinder −12.0% of income | pass |
| Always-on XP bait: milestone active time against the same archetype without bait, every milestone from L20 (integrated) | ≤ 10% sooner (roughly) | casual 6.7% (L50), regular 9.7% (L60), active 11.5% (L60), grinder 11.8% (L60) | **flag for the user**: over for active, grinder (`P-BAIT-XP-SIZING`) |
...
| L20 | 5–6 h | 5.27 h | yes | 5.27 h | 5.27 h | 0.0% | yes |
| L30 | 12–15 h | 12.53 h | yes | 12.45 h | 11.67 h | 6.9% | yes |
| L40 | 24–30 h | 25.05 h | yes | 24.77 h | 22.73 h | 9.3% | yes |
| L50 | 40–45 h | 43.52 h | yes | 42.77 h | 39.42 h | 9.4% | yes |
| L60 | — | 69.57 h | — | 68.57 h | 62.85 h | 9.7% | yes |

Regular player (45 min/day). Model: integrate.run(), the reference core loop (rods, world, quests, streak, buffs); the bait columns add system({ policy }) through variant.bait 'cash' | 'xp'. The approved windows describe the no-bait reference player; a bait buyer is held to the XP-bait guard instead (`P-BAIT-XP-SIZING`).
...
| --- | --- | --- | --- | --- | --- |
| no bait | 0.0% | 0.0% | **0.0%** | 78.7% / 0.0% / 4.6% / 14.5% / 2.2% | — |
| money bait | 4.4% | 6.0% | **+1.7%** | 77.3% / 1.6% / 4.6% / 14.3% / 2.2% | Shrimp, Worm, Magnet, Fly, Bloodworm |
| XP bait | 14.5% | 5.6% | **−8.9%** | 71.1% / 9.6% / 4.3% / 12.7% / 2.3% | Shrimp, Worm, Lure, Magic Lure |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| casual (12.5 min/day) | 0.0% | 5.0% | 6.4% | 6.7% | 6.6% | 6.7% (L50) | yes | $776,313 → $298,521 | −5.4% | yes / yes | pass |
| regular (45 min/day) | 0.0% | 6.9% | 9.3% | 9.4% | 9.7% | 9.7% (L60) | yes | $1,202,184 → $465,567 | −8.9% | yes / yes | pass |
| active (120 min/day) | 0.0% | 7.2% | **10.1%** | **10.5%** | **11.5%** | 11.5% (L60) | **no** (L40, L50, L60) | $1,364,834 → $527,895 | −11.0% | yes / yes | **flag** |
| grinder (300 min/day) | 0.0% | 7.3% | **10.3%** | **10.6%** | **11.8%** | 11.8% (L60) | **no** (L40, L50, L60) | $1,438,906 → $558,204 | −12.0% | yes / yes | **flag** |
...
| --- | --- | --- | --- | --- | --- | --- |
| casual (12.5 min/day) | 38.38 h | 37.93 h | 35.82 h | 1.4% (L60) | 6.7% (L50) | no |
| regular (45 min/day) | 43.52 h | 42.77 h | 39.42 h | 1.7% (L50) | 9.7% (L60) | no |
| active (120 min/day) | 44.02 h | 43.48 h | 39.42 h | 1.9% (L60) | 11.5% (L60) | **yes** |
| grinder (300 min/day) | 40.20 h | 39.80 h | 35.93 h | 2.1% (L60) | 11.8% (L60) | **yes** |
...
| money bait | Magnet | 2,929 | $16,402 | $18,727 | 1.14 | 726 | −$3.20 |
| money bait | Fly | 5,068 | $30,406 | $48,063 | 1.58 | 2,884 | −$6.12 |
| money bait | Bloodworm | 18,875 | $339,744 | $466,767 | 1.37 | 14,736 | −$8.62 |
| XP bait | Shrimp | 480 | $1,920 | $2,517 | 1.31 | 0 | — |
| XP bait | Worm | 1,627 | $7,483 | $9,646 | 1.29 | 0 | — |
| XP bait | Lure | 7,164 | $103,872 | $0 | 0.00 | 25,585 | $4.06 |
| XP bait | Magic Lure | 17,284 | $1,088,910 | $453,405 | 0.42 | 77,258 | $8.23 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| proposed (PARAMS) | +10.0% extra-fish | +15.0% XP | +12.0% XP | $23.50 / $14.50 / $63.00 | 6.7% (L50) | 9.7% (L60) | **11.5% (L60)** | **11.8% (L60)** | yes | **no** (active, grinder) | −8.9% |
| design-stage alternative | +5.0% extra-fish | +8.0% XP | +8.0% XP | $11.50 / $7.70 / $52.50 | 4.5% (L60) | 6.9% (L60) | 7.9% (L60) | 8.1% (L60) | yes | yes | −6.1% |
| largest uniform scale passing the guard for every archetype (×0.809; a bound, not a proposal) | +8.1% extra-fish | +12.1% XP | +9.7% XP | $19.00 / $11.50 / $57.00 | 5.9% (L60) | 8.3% (L60) | 9.8% (L60) | 10.0% (L60) | yes | yes | −7.4% |
