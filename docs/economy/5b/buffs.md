...
| Buffs a regular player receives per 30 days (integrated) | 3.84: Double XP 0.86, Double Cash 1.86, Lucky Draw 1.12; today 0.24 (1.02 with the retiring Top.gg votes) | Sources per 30 days |
| Share of fishing income buffs add, first 30 days (Double Cash + Lucky Draw) | casual 16.5% (6.1% + 10.3%), regular 8.3% (6.2% + 2.1%), active 4.4% (3.0% + 1.3%), grinder 1.3% (1.2% + 0.1%) | Income share |
| Share of XP from Double XP, first 30 days | 0.54%–2.22% | Income share |
| Decision 8, regular player, 90 days | uncapped sale-time hoarder +73.0% of fishing income vs catch-time +6.2% | Decision 8 |
| Regular player with buffs (reference loop) | L20 5.15 h, L30 12.75 h, L40 24.90 h, L50 42.93 h; every approved window met; milestones 2.50% earlier than without buffs at most | R2 windows |
| Minimum-daily player vs casual (R2) | PASS | R2 minimum-daily |
| No-miss grinder: largest milestone shift from buffs | 0.58% (PASS) | R2 windows |
...
| Design checks | 24 of 24 pass | Checks |

<sub>Generated by `node scripts/economy/5b/render-docs.js` from `buffs.js` markdownTables() at framework 5b.5 (digest d7374a03d62e8b81).</sub>
<!-- /generated:buffs-headline -->
...
| `P-BUFFS-TARGETS` | Buff income targets: the steady-state check excludes events; the event budget has its own event-inclusive guard | steady state (streak + quest buffs) <= 8% / 8% / 5% / 3% of fishing income in the first 30 days (casual / regular / active / grinder); with the event budget <= 20% / 10% / 7% / 5% | one combined target including events (fails for casual and regular while P-EVENTS stays); cut or stretch the event Lucky Draw | every archetype passes the steady-state target without events; events are meant to feel unusually rewarding, so they get a separate ceiling rather than a nerf | yes |
...
| `P-BUFFS-SOURCES` | Buff sources: the streak boxes (Double XP and Double Cash only, no Lucky Draw), the quest Daily Boxes (pool unchanged) and the event budget; the Lucky Draw is a rarer reward from the Daily Box, events and the Booster Pack; no shop sale; the Booster Pack keeps its buffs and is never valued | streak (Streak Crate / Chest, without Lucky Draw: streak.js P-STREAK-ITEM-POOL), quests (Daily Box), events (F.EVENTS, P-EVENTS); Lucky Draw from quests, events (+ the unvalued Booster Pack); Booster Pack unvalued; shop none | Lucky Draw in streak boxes too (the earlier proposal: about a Lucky Draw more per 30 days for a daily player, most of it an early-assembly rebate); a shop sale (converts cash into levels, or a guaranteed-return investment); re-weighted streak/quest pools (a Gacha V2 featured change) | Double XP stays at the streak rate (the regular player's windows have little headroom); the Lucky Draw is worth the most on a tier assembly, so a daily source made it common and its rebate the largest buff value for casual players; the event budget is the one lever the operator can schedule, measure and switch off (sources tables) | yes |
...
| --- | --- | --- | --- | --- | --- |
| today: Daily Box only | 0.08 | 0.3% / 8.7% / 1.7% | 0.3% / 7.8% / 0.4% | 0.1% / 8.9% / 0.1% | 0.1% / 10.1% / 0.0% |
| today: Daily Box + Top.gg votes | 0.34 | 1.1% / 30.6% / 7.2% | 1.1% / 28.0% / 1.5% | 0.6% / 31.2% / 0.5% | 0.2% / 35.0% / 0.2% |
| proposed without events | 0.85 | 2.8% / 55.0% / 17.8% | 2.8% / 50.9% / 3.7% | 1.4% / 55.7% / 1.2% | 0.6% / 60.7% / 0.4% |
| proposed | 1.85 | 6.1% / 75.2% / 38.2% | 6.2% / 73.0% / 8.0% | 3.1% / 75.6% / 2.6% | 1.2% / 79.7% / 0.9% |
...
| --- | --- | --- | --- | --- |
| Casual | 6.12% | 39.35% | 1.54% | 9.31% |
| Regular | 6.20% | 8.03% | 2.22% | 2.90% |
| Active | 3.04% | 2.54% | 1.27% | 1.07% |
| Grinder | 1.22% | 0.85% | 0.54% | 0.38% |
| Minimum-daily | 6.10% | 93.25% | 1.10% | 15.88% |
...
| Casual | Lake (Lv 20, t2) | $4,652 (12.5 min) | $22,331 | 1,364 | T3: $36,801 (1.65 h) | $308 |
| Casual | Coast (Lv 40, t4) | $12,589 (12.5 min) | $60,426 | 1,826 | T5: $156,774 (2.59 h) | $456 |
| Casual | Swamp (Lv 50, t5) | $20,741 (12.5 min) | $99,556 | 2,059 | T6: $0 (0.00 h) | $567 |
| Regular | Ocean (Lv 0, old) | $6,411 (45.0 min) | $8,548 | 5,596 | T1: $3,325 (0.39 h) | $207 |
| Regular | River (Lv 10, t1) | $13,421 (45.0 min) | $17,895 | 5,676 | T2: $13,704 (0.77 h) | $257 |
| Regular | Lake (Lv 20, t2) | $22,426 (45.0 min) | $29,901 | 6,575 | T3: $36,801 (1.23 h) | $308 |
| Regular | Pond (Lv 30, t3) | $36,141 (45.0 min) | $48,188 | 7,520 | T4: $99,608 (2.07 h) | $380 |
| Regular | Coast (Lv 40, t4) | $61,315 (45.0 min) | $81,753 | 8,895 | T5: $156,774 (1.92 h) | $456 |
| Regular | Swamp (Lv 50, t5) | $101,819 (45.0 min) | $135,758 | 10,109 | T6: $0 (0.00 h) | $567 |
| Grinder | Lake (Lv 20, t2) | $38,631 (60.0 min) | $38,631 | 11,327 | T3: $36,801 (0.95 h) | $308 |
| Grinder | Swamp (Lv 50, t5) | $179,201 (60.0 min) | $179,201 | 17,791 | T6: $0 (0.00 h) | $567 |
...
| --- | --- | --- |
| Streak Crate | 2.365% | 4.73% |
| Streak Chest | 3.154% | 6.31% |
...
- **The Lucky Draw is a rarer reward (your decision).** Streak Crates and Streak Chests no longer contain it (streak design, `P-STREAK-ITEM-POOL`). It comes from the Daily Box, events and the Booster Pack (check `lucky-draw-sources`). A daily streak source made the Lucky Draw common, and its assembly rebate was the largest buff value a casual player received. No cash replaces it in the streak boxes. Without it the streak's Rare item slot is shared by Double XP, Double Cash and the Rare bait, so their per-open odds rise slightly (per-open table).
- **The quest pool is unchanged.** A future re-weighting would be a Gacha V2 `featured` change in the pool; `boxBuffOdds()` values any pool.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Casual | 1.79 | 3.74% | 1.54% | 3.79 | 16.45% | 1.54% | 2.45% / 0.34% / 3.33% |
| Regular | 1.84 | 3.08% | 2.22% | 3.84 | 8.28% | 2.22% | 2.47% / 0.40% / 3.33% |
| Active | 1.85 | 1.55% | 1.27% | 3.85 | 4.36% | 1.27% | 1.21% / 0.20% / 1.63% |
| Grinder | 1.85 | 0.58% | 0.54% | 3.85 | 1.32% | 0.54% | 0.49% / 0.08% / 0.66% |
...
- **Open issue: the 30-day cash-share targets still fail for casual and regular players** (cash-share checks table, §16). Removing the Lucky Draw from streak boxes brought the active player under target and cut the casual share materially, but the casual share is still far above the target. The Double Cash part alone stays inside every target. What remains is mostly the event budget (`P-EVENTS`): its Lucky Draw lands on the early T1/T2 assemblies, and the casual player funds those mostly from quest and streak cash. So a single Lucky Draw is a large share of their small *fishing* income (compare the "of all cash income" column). Without events every archetype passes (with/without-events table). This is reported, not tuned: see §16 for the options.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Casual | 20 | 5.02 -> 4.92 | 24 | 28,123 | 19,614 | 755 (quests 89, streak 665) | 58.0% / 40.4% / 1.56% |
| Casual | 30 | 12.50 -> 12.30 | 59 | 77,821 | 52,655 | 2,158 (quests 262, streak 1,896) | 58.7% / 39.7% / 1.63% |
| Casual | 40 | 23.55 -> 23.13 | 111 | 161,663 | 128,849 | 4,515 (quests 547, streak 3,968) | 54.8% / 43.7% / 1.53% |
| Casual | 50 | 39.75 -> 38.95 | 187 | 307,322 | 262,221 | 8,615 (quests 1,037, streak 7,579) | 53.2% / 45.4% / 1.49% |
| Regular | 20 | 5.27 -> 5.15 | 7 | 39,364 | 8,118 | 933 (quests 134, streak 799) | 81.3% / 16.8% / 1.93% |
| Regular | 30 | 13.05 -> 12.75 | 17 | 108,122 | 21,902 | 2,937 (quests 405, streak 2,532) | 81.3% / 16.5% / 2.21% |
| Regular | 40 | 25.52 -> 24.90 | 34 | 235,456 | 52,442 | 6,552 (quests 884, streak 5,667) | 80.0% / 17.8% / 2.23% |
| Regular | 50 | 44.03 -> 42.93 | 58 | 461,763 | 103,595 | 12,981 (quests 1,665, streak 11,317) | 79.8% / 17.9% / 2.24% |
| Active | 20 | 4.98 -> 4.93 | 3 | 42,451 | 5,555 | 503 (quests 109, streak 394) | 87.5% / 11.5% / 1.04% |
| Active | 30 | 12.82 -> 12.65 | 7 | 121,308 | 9,689 | 1,538 (quests 240, streak 1,297) | 91.5% / 7.3% / 1.16% |
| Active | 40 | 25.12 -> 24.77 | 13 | 265,300 | 25,439 | 3,691 (quests 587, streak 3,105) | 90.1% / 8.6% / 1.25% |
| Active | 50 | 43.73 -> 43.13 | 22 | 527,512 | 43,329 | 7,500 (quests 1,046, streak 6,453) | 91.2% / 7.5% / 1.30% |
| Grinder | 20 | 4.67 -> 4.67 | 1 | 46,033 | 2,460 | 0 (none) | 94.9% / 5.1% / 0.00% |
| Grinder | 30 | 11.43 -> 11.37 | 3 | 124,670 | 7,121 | 740 (quests 185, streak 555) | 94.1% / 5.4% / 0.56% |
| Grinder | 40 | 22.63 -> 22.52 | 5 | 277,636 | 15,311 | 1,569 (quests 365, streak 1,203) | 94.3% / 5.2% / 0.53% |
| Grinder | 50 | 39.45 -> 39.25 | 8 | 554,573 | 20,751 | 3,050 (quests 539, streak 2,511) | 95.9% / 3.6% / 0.53% |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Casual | 1.27 -> 1.25 | 5.02 -> 4.92 | 12.50 -> 12.30 | 23.55 -> 23.13 | 39.75 -> 38.95 | 61.45 -> 60.43 | 2.01% |
| Regular | 1.18 -> 1.18 | 5.27 -> 5.15 | 13.05 -> 12.75 | 25.52 -> 24.90 | 44.03 -> 42.93 | 69.77 -> 68.37 | 2.50% |
| Active | 1.12 -> 1.12 | 4.98 -> 4.93 | 12.82 -> 12.65 | 25.12 -> 24.77 | 43.73 -> 43.13 | 69.62 -> 68.67 | 1.39% |
| Grinder | 0.98 -> 0.98 | 4.67 -> 4.67 | 11.43 -> 11.37 | 22.63 -> 22.52 | 39.45 -> 39.25 | 62.65 -> 62.30 | 0.58% |

| Regular player window | Hours without buffs | Hours with buffs | Inside |
| --- | --- | --- | --- |
| L20: 5–6 h | 5.27 | 5.15 | yes |
| L30: 12–15 h | 13.05 | 12.75 | yes |
| L40: 24–30 h | 25.52 | 24.90 | yes |
| L50: 40–45 h | 44.03 | 42.93 | yes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 7 | 7 | 0.35 | 17,935 | 897 | 0.95% | 11 | 1.47 | 9,157 | 1,919 | 1.40% | no |
| 28 | 16 | 1.65 | 18,909 | 1,114 | 1.08% | 21 | 5.85 | 10,149 | 2,120 | 1.56% | no |
| 91 | 29 | 5.85 | 21,078 | 1,355 | 1.11% | 36 | 18.97 | 12,350 | 2,574 | 1.54% | no |
| 182 | 42 | 14.72 | 24,225 | 1,959 | 1.15% | 49 | 37.93 | 14,757 | 3,076 | 1.49% | no |
| 364 | 59 | 34.72 | 29,174 | 2,783 | 1.17% | 65 | 75.85 | 18,706 | 3,898 | 1.40% | no |
...
| --- | --- | --- | --- |
| Streak Crate: each buff type per open | 2.37% | 2.37% | Founder gacha luck on non-buff slots only: buffs at normal odds |
| Streak Chest: each buff type per open | 3.15% | 3.15% | Founder gacha luck on non-buff slots only: buffs at normal odds |
| Daily Box: each buff type per open | 0.26% | 0.26% | Founder gacha luck on non-buff slots only: buffs at normal odds |
| Double XP per 30 days (regular play) | 0.86 | 0.86 | x1.00 |
| Double Cash per 30 days (regular play) | 1.86 | 1.86 | events grant the same to everyone |
| Lucky Draw per 30 days (regular play) | 1.12 | 1.12 | events grant the same to everyone |
| Public XP drift (share of XP) | 0 | 0.00% | extra Double XP units a day x fishing's share of XP at L50 (79.8%) |
| Public level drift at L50 | 0 | 0.00 | levels ahead of an identical normal player |
...
- **Streak:** its pools hold Double XP and Double Cash but no Lucky Draw (`P-STREAK-ITEM-POOL`). It emits one `box` event per streak box and books only the non-buff contents; the buff units it grants are all received here (check `buff-value-counted-once`).
...
- **Open issue: the 30-day cash-share targets** (`PARAMS.targets.cashShareMax30d`) still fail for casual and regular players (cash-share checks table below; income share table). Your decision removed the Lucky Draw from streak boxes. That brought the active player under target and cut the casual share materially, but the casual share is still far above the target. The Double Cash part is inside every target. The excess is now almost all the event budget (`P-EVENTS`: one Double Cash and one Lucky Draw per 30 days). The event Lucky Draw lands on an early T1/T2 assembly and is measured against the casual player's small fishing income. Without events every archetype passes (with/without-events table, "without events" column). The event budget was kept as `P-EVENTS` specifies. Meeting the casual and regular targets needs a decision on it or on the target. The options, each a decision for you:
  ...
  - change the event budget (`P-EVENTS`): no event Lucky Draw, or one every 60 days. Dropping the event budget entirely brings every archetype under target on fishing income (with/without-events table);
  - a smaller Lucky Draw (K = 1, Lucky Draw K table).
...
| `cash-share-casual` | yes | steady state (events excluded): buffs add 3.74% of fishing income in 30 days (max 8%) |
| `event-budget-casual` | yes | with the event budget: buffs add 16.45% of fishing income in 30 days (max 20%) |
| `xp-share-casual` | yes | Double XP adds 1.54% of XP in 30 days (max 3%) |
| `cash-share-regular` | yes | steady state (events excluded): buffs add 3.08% of fishing income in 30 days (max 8%) |
| `event-budget-regular` | yes | with the event budget: buffs add 8.28% of fishing income in 30 days (max 10%) |
| `xp-share-regular` | yes | Double XP adds 2.22% of XP in 30 days (max 3%) |
| `cash-share-active` | yes | steady state (events excluded): buffs add 1.55% of fishing income in 30 days (max 5%) |
| `event-budget-active` | yes | with the event budget: buffs add 4.36% of fishing income in 30 days (max 7%) |
| `xp-share-active` | yes | Double XP adds 1.27% of XP in 30 days (max 3%) |
| `cash-share-grinder` | yes | steady state (events excluded): buffs add 0.58% of fishing income in 30 days (max 3%) |
| `event-budget-grinder` | yes | with the event budget: buffs add 1.32% of fishing income in 30 days (max 5%) |
| `xp-share-grinder` | yes | Double XP adds 0.54% of XP in 30 days (max 3%) |
| `lucky-draw-sources` | yes | regular, 30 days: Lucky Draws by source events 1.00, quests 0.12, streak 0.00 (allowed: quests, events); Streak Crate / Chest odds 0.0000 / 0.0000 |
| `buffs-per-30-days` | yes | 3.84 buffs per 30 days for the regular player (target 3-6) |
| `regular-in-windows-with-buffs` | yes | L20 5.15 h, L30 12.75 h, L40 24.9 h, L50 42.9333 h |
| `window-shift-small` | yes | regular milestones move 2.50% with the buffs system (max 3%) |
...
| `no-miss-grinder` | yes | grinder milestones move 0.58% with the buffs system (max 3%) |
| `sale-time-uncapped-rewards-stockpiles` | yes | 90 days, regular: sale-time hoarder +73.0% vs catch-time +6.2% (why catch-time) |
...
| `buff-value-counted-once` | yes | regular, 90 days: ledger 'buff' / 'luckyDraw' = the system's own credits; streak buff units granted 4.4465 = received here 4.4465 |
