...
| Design checks | 18 of 20 pass (failing: cash-share-casual, cash-share-regular) | Checks |
...
| --- | --- | --- | --- |
| Streak Crate: each buff type per open | 2.37% | 4.94% | Founder gacha luck (buffs are Rare items) |
| Streak Chest: each buff type per open | 3.15% | 6.59% | Founder gacha luck (buffs are Rare items) |
| Daily Box: each buff type per open | 0.26% | 0.70% | Founder gacha luck (buffs are Rare items) |
| Double XP per 30 days (regular play) | 0.86 | 1.86 | x2.16 |
| Double Cash per 30 days (regular play) | 1.86 | 2.86 | events grant the same to everyone |
| Lucky Draw per 30 days (regular play) | 1.12 | 1.31 | events grant the same to everyone |
| Public XP drift (share of XP) | 0 | 2.66% | extra Double XP units a day x fishing's share of XP at L50 (79.8%) |
| Public level drift at L50 | 0 | 0.42 | levels ahead of an identical normal player |
...
| `cash-share-casual` | **NO** | buffs add 16.45% of fishing income in 30 days (max 8%) |
| `xp-share-casual` | yes | Double XP adds 1.54% of XP in 30 days (max 3%) |
| `cash-share-regular` | **NO** | buffs add 8.28% of fishing income in 30 days (max 8%) |
| `xp-share-regular` | yes | Double XP adds 2.22% of XP in 30 days (max 3%) |
| `cash-share-active` | yes | buffs add 4.36% of fishing income in 30 days (max 5%) |
| `xp-share-active` | yes | Double XP adds 1.27% of XP in 30 days (max 3%) |
| `cash-share-grinder` | yes | buffs add 1.32% of fishing income in 30 days (max 3%) |
